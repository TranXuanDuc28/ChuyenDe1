...
document.getElementById('total-mo').innerHTML = Number(document.getElementById('price-tour-people').innerHTML)+' VNĐ';
document.getElementById('countPeople').addEventListener('change', function(){
    ...
    document.getElementById('total-mo').innerHTML =  pricePeople * countPeople +' VNĐ';
});*/

// form BookNow
document.getElementById('total-mo-booking').style.fontWeight = 'bold';
document.getElementById('total-mo-booking').innerHTML =  Number(document.getElementById('price-tour-peopleB').innerHTML)+' VNĐ';
document.getElementById('countPeopleBooking').addEventListener('change', function(){
    ...
    document.getElementById('total-mo-booking').innerHTML =  pricePeople * countPeople +' VNĐ';
});
